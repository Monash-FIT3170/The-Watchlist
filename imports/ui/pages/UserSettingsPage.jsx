...
const UserSettingsPage = () => {
  ...
  const handleSaveUsername = () => {
    Meteor.call("updateUsername", newUsername, (error) => {
      if (error) {
        setUsernameError(error.reason);
      } else {
        setUsernameError("");
        setSuccessMessage("Username updated successfully!");
        setNewUsername(""); // Optionally reset the input field
      }
    });
  };
  ...
  return (
    <>
      ...
      <div classname="flex flex-col items-center">
        <h1 className="ml-4 text-4xl text-white font-bold mb-2">
          Profile Visibility
        </h1>
        ...
        <button className="mb-1 mt-8 ml-64 text-md text-white py-2 px-6 rounded-full shadow bg-less-dark hover:bg-darker">
          Save
        </button>

        <h1 className="ml-4 mt-8 text-4xl text-white font-bold mb-2">
          Change Username
        </h1>
        <div className="ml-4 mt-2">
          <input
            ...
            className="text-input mt-2 p-2 rounded-lg text-white w-80 shadow bg-less-dark hover:bg-darker "
          />
          {usernameError && (
        ...
        <button
          className="mb-1 mt-8 text-md text-white py-2 px-6 rounded-full shadow bg-less-dark hover:bg-darker"
          onClick={handleSaveUsername}
        >
          Save Username
        </button>

        <h1 className="ml-4 mt-8 text-4xl text-white font-bold mb-4">
          Profile Photo
        </h1>
        <div className="flex flex-row mt-8">
          ...
          />
          <button className="h-12  mt-10 ml-24 text-white bg-less-dark  hover:bg-darker rounded-full py-2 px-6">
            Change Photo
          </button>
        </div>
      </div>
