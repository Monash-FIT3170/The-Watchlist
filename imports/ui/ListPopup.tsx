...
const ListPopup: React.FC<ContentListProps> = ({ list, onClose }) => {
  ...
  return (
    ...
    <div className = "fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
      <div ref={popupRef} className="bg-black p-6 rounded-lg w-11/12 md:w-3/4 lg:w-1/2 max-h-3/4 overflow-y-auto relative">
      <div className="flex justify-between items-center mb-4">
        ...
        <div ref={scrollContainerRef} className ="space-y-8 overflow-y-auto max-h-[calc(100vh-5rem)]">
            ...
            <div key={item.id} className="block relative">
              ...
              {expandedItem === item.id && (
                <div className="mt-4 p-4 bg-gray-900 rounded-lg">
                  ...
                  <p><strong>Director:</strong> Director McDirector</p>
                </div>
              )}
            </div>
          ))}
